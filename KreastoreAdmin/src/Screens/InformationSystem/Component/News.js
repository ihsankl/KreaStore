  ...
  const tableData = [
    {
      ...
      judul: 'Kompor Bahan Bakar Air',
      harga: 1000000,
      tanggal: '2021-08-17',
      thread:
        'kompor dengan bahan bakar air, dapat menjadi alternatif apabila tidak ada bahan bakar minyak di daerahmu',
      comment: 10,
      userComment: [
        {
          username: 'Maman',
